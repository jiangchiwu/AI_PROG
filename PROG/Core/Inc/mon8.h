...
#define MON8_CLOCK_400KHZ    400000
...
#define MON8_Enable()      HAL_GPIO_WritePin(g_mon8_config.rst_port, g_mon8_config.rst_pin, GPIO_PIN_SET)
#define MON8_Disable()     HAL_GPIO_WritePin(g_mon8_config.rst_port, g_mon8_config.rst_pin, GPIO_PIN_RESET)
